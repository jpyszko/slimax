...
/*!
 * Klasa konretna edytora listy wyboru (combobox) słuzącej do wyboru typu rośliny w tabeli edycji roślin
 */
...
public:
    ...
    /*!
     * Przeciązona metoda QStyledItemDelegate odpowiedzalna za tworzenie nowych instancji listy wyboru typów roślin (combobox)
